...
{    
    ...
    typeless messangeFor((int*)0, INT); //денис ты ебаный гандон сука кто програмирует моя бабка на хадолях так не ходит как ты гандон указатели юзаешь дегинират 
